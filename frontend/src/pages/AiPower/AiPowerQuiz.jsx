    ...
    return (
      <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <div className="mb-4">
          ...
          <select value={questionCategory} onChange={handleCategoryChange} className="border rounded">
            <option>All</option>
        ...
        <div className="mb-4">
          <h2 className="text-2xl font-semibold mb-2">Slected Difficulty:</h2>
          <select value={questionDifficulty || 'all'} onChange={handleDifficultyChange} className="border rounded">
        ...
        <div className="mb-4">
          ...
          <select value={questionType} onChange={handleTypeChange} className="border rounded">
        ...
        <div className="mb-4">
          ...
          <input value={questionAmount} onChange={handleAmountChange} className="border rounded" />
        </div>
